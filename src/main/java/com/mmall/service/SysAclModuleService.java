...
public class SysAclModuleService {
    ...
    private void updateWithChild(SysAclModule before,SysAclModule after){
        ...
        if(!after.getLevel().equals(before.getLevel())){
            List<SysAclModule> aclModulesList=sysAclModuleMapper.getChildAclModuleListByLevel(before.getLevel());
            if(CollectionUtils.isNotEmpty(aclModulesList)){
                for(SysAclModule aclModule:aclModulesList){
                ...
                sysAclModuleMapper.batchUpdateLevel(aclModulesList);
            }
        }
